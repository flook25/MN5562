...
% Loop 3
quiver(0,0, real(V_Cyan_Up_1), imag(V_Cyan_Up_1), 0, 'cyan', 'LineWidth', 3, 'MaxHeadSize', 0.5);
...
% Loop 3
quiver(0,0, real(V_Cyan_Up_2), imag(V_Cyan_Up_2), 0, 'cyan', 'LineWidth', 3, 'MaxHeadSize', 0.5);
