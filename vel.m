...
% Cyan at 0,0
quiver(real(R_Cyan), imag(R_Cyan), real(V_Cyan)*Scale, imag(V_Cyan)*Scale, 0, 'c', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
% Cyan Up at 0,0
quiver(real(R_Cyan_Up), imag(R_Cyan_Up), real(V_Cyan_Up)*Scale, imag(V_Cyan_Up)*Scale, 0, 'c', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
...
quiver(real(R_Cyan_2), imag(R_Cyan_2), real(V_Cyan_2)*Scale, imag(V_Cyan_2)*Scale, 0, 'c', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
quiver(real(R_Cyan_Up_2), imag(R_Cyan_Up_2), real(V_Cyan_Up_2)*Scale, imag(V_Cyan_Up_2)*Scale, 0, 'c', 'LineWidth', 1.5, 'MaxHeadSize', 0.5);
