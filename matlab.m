...
w42 = (a*w2*sin(q2-q32))/(c*sin(q42-q32)); % Angular velocity W42 for Open circuit
w32 = (a*w2*sin(q42-q2))/(b*sin(q32-q42)); % Angular velocity W32 for Open circuit
...
quiver(RAx,RAy,VAx/30,VAy/30,0,'red','MaxHeadSize',0.5,'LineWidth',2); 
hold on
quiver(RB2x,RB2y,VBA2x/30,VBA2y/30,0,'blue','MaxHeadSize',0.5,'LineWidth',2); 
quiver(RB2x,RB2y,VBx/30,VBy/30,0,'green','MaxHeadSize',0.5,'LineWidth',2); 
quiver(RB2x,RB2y,VB2x/30,VB2y/30,0,'black','MaxHeadSize',0.5,'LineWidth',2); 
...
quiver(RAx,RAy,AAx/500,AAy/500,0,'red','MaxHeadSize',0.5,'LineWidth',2); 
quiver(RB2x,RB2y,ABAx/500,ABAy/500,0,'blue','MaxHeadSize',0.5,'LineWidth',2); 
quiver(RB2x,RB2y,ABx/500,ABy/500,0,'black','MaxHeadSize',0.5,'LineWidth',2); 
