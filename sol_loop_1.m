...
L1 = 0.210; % Link 1 (d, Ground)
L2 = 0.180; % Link 2 (a, Crank)
L3 = 0.180; % Link 3 (b, Coupler)
L4 = 0.118; % Link 4 (c, Rocker)
...
% To find Theta 4 (Rocker), use Inverse K constants (Swap a and b):
K1 = d/b; 
K2 = d/c;
K3 = (b^2 - a^2 + c^2 + d^2)/(2*b*c); 

% To find Theta 2 (Crank), use Inverse K constants (Swap a and b):
K4 = d/a; 
