...
% --- Solve (Standard Plus Sqrt for Crossed) ---
...
% --- Plotting Case 1 ---
figure(1)
title('Case 1: Open Circuit (Input 17.944)');
hold on;
quiver(0,0, RO4O2x, RO4O2y, 0, 'Color', [1 0 1], 'MaxHeadSize', 0.5, 'LineWidth', 4);  % Pink
quiver(0,0, RA1x, RA1y, 0, 'cyan', 'MaxHeadSize', 0.5, 'LineWidth', 3); % Cyan (UP)
quiver(RA1x, RA1y, RBA1x, RBA1y, 0, 'blue', 'MaxHeadSize', 0.5, 'LineWidth', 3); % Blue
quiver(RO4O2x, RO4O2y, RBO4_1x, RBO4_1y, 0, 'Color', [0.85 0.5 0.1], 'MaxHeadSize', 0.5, 'LineWidth', 3); % Brown
axis equal; grid on;
xlabel('x (m)'); ylabel('y (m)');

% --- Plotting Case 2 ---
figure(2)
title('Case 2: Crossed Circuit (Input 92.2333)');
hold on;
quiver(0,0, RO4O2x, RO4O2y, 0, 'Color', [1 0 1], 'MaxHeadSize', 0.5, 'LineWidth', 4);  % Pink
quiver(0,0, RA2x, RA2y, 0, 'cyan', 'MaxHeadSize', 0.5, 'LineWidth', 3); % Cyan (UP)
quiver(RA2x, RA2y, RBA2x, RBA2y, 0, 'blue', 'MaxHeadSize', 0.5, 'LineWidth', 3); % Blue
quiver(RO4O2x, RO4O2y, RBO4_2x, RBO4_2y, 0, 'Color', [0.85 0.5 0.1], 'MaxHeadSize', 0.5, 'LineWidth', 3); % Brown
axis equal; grid on;
xlabel('x (m)'); ylabel('y (m)');
