...
% ==========================================
% CASE 1: Open Circuit (Input = -17.944) -> Force UP
% ==========================================
q2d_open = -17.944;
...
% --- Solve (Using PLUS Sqrt to force UP configuration) ---
...
% ==========================================
% CASE 2: Crossed Circuit (Input = -92.2333) -> Force UP/Cross
% ==========================================
q2d_cross = -92.2333;
...
% --- Solve (Using MINUS Sqrt for Alternate Config) ---
...
% --- Plotting Case 1 ---
figure(1)
title('Case 1: Open Circuit (Forced UP)');
hold on;
